#include "test_nucleus_in_cell_contact_via_coupling.hpp"


//Check the contact model contact_node_node_via_coupling by growing a nucleus inside an epithelial cell. If the 
...
int run_nucleus_in_cell_test() noexcept{
    ...
    sim_parameters.input_mesh_path_ =               std::string(PROJECT_SOURCE_DIR) + "/test/test_contact_models/test_contact_node_node_via_coupling/test_nucleus_in_cell_contact_via_coupling/nucleus_in_cell_geometry.vtk";
    sim_parameters.output_folder_path_ =            std::string(CMAKE_BINARY_DIR) + "/test_nucleus_in_cell_contact_via_coupling/";
