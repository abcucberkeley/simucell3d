#include "test_cell_in_ecm_contact_via_springs.hpp"



//Check the contact model contact_node_face_via_spring by growing a cell inside a static ECM cell. If the 
...
int run_cell_in_ecm_test() noexcept{
    ...
    sim_parameters.input_mesh_path_ =               std::string(PROJECT_SOURCE_DIR) + "/test/test_contact_models/test_contact_node_face_via_springs/test_cell_in_ecm_contact_via_springs/cell_in_ecm_geometry.vtk";
    sim_parameters.output_folder_path_ =            std::string(CMAKE_BINARY_DIR) + "/test_cell_in_ecm/";
